                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                <label for="password-confirm"
                                    class="col-md-4 col-form-label text-md-right">{{ __('Confirmez votre Mot de Passe') }}</label>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                                        name="name"  required autocomplete="name" autofocus><br>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="centre" id="centre" class="form-control" required><br>
                                </div>
                            </div>

                            <div>
                                <input type="checkbox" name="cookies" id="cookies" required>
                                <label for="cookies">J'accepte que Y-Work utilise des cookies pour ma navigation sur le site.</label><br><br>
                            </div>
